...
聚游助手 v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `juyou-switcher-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `juyou-switcher-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `juyou-switcher-v3.8.0-Linux.AppImage` or `.deb`
...
- [@yangp0419](https://github.com/yangp0419) - Bug fixes and feature enhancements
...
[Use code "juyou-switcher" for 10% off registration](https://www.packyapi.com/register?aff=juyou-switcher)
...
- **Issue Reports**: [GitHub Issues](https://github.com/yangp0419/juyou-switcher/issues)
