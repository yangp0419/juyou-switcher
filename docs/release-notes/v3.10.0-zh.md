...
聚游助手 v3.10.0 新增 OpenCode 支持，成为第四个受管理的 CLI 应用。
...
| 文件                                     | 说明                                |
| ---------------------------------------- | ----------------------------------- |
| `juyou-switcher-v3.10.0-Windows.msi`          | **推荐** - MSI 安装包，支持自动更新 |
| `juyou-switcher-v3.10.0-Windows-Portable.zip` | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                             | 说明                                                      |
| -------------------------------- | --------------------------------------------------------- |
| `juyou-switcher-v3.10.0-macOS.zip`    | **推荐** - 解压后拖入 Applications 即可，Universal Binary |
| `juyou-switcher-v3.10.0-macOS.tar.gz` | 用于 Homebrew 安装和自动更新                              |
