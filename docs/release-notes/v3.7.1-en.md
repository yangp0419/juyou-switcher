...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S juyou-switcher-bin`
...
Visit [Releases](https://github.com/yangp0419/juyou-switcher/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `juyouswitcher://` protocol
...
v3.7.0 represents a shift in 聚游助手's positioning:
...
Visit [Releases](https://github.com/yangp0419/juyou-switcher/releases/latest) to download:

- **Windows**: `juyou-switcher-Windows.msi` or `-Portable.zip`
- **macOS**: `juyou-switcher-macOS.tar.gz` or `.zip`
- **Linux**: `juyou-switcher-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S juyou-switcher-bin`
...
- [@yangp0419](https://github.com/yangp0419) - From developer to issue responder
...
[Register with "juyou-switcher" code for 10% discount](https://www.packyapi.com/register?aff=juyou-switcher)
...
- **Issues**: [GitHub Issues](https://github.com/yangp0419/juyou-switcher/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yangp0419/juyou-switcher/discussions)
