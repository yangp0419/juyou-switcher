...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S juyou-switcher-bin`
...
访问 [Releases](https://github.com/yangp0419/juyou-switcher/releases/latest) 下载最新版本
...
- **深度链接集成** - 通过 `juyouswitcher://` 协议导入配置
- **系统托盘** - 从托盘菜单快速切换
...
访问 [Releases](https://github.com/yangp0419/juyou-switcher/releases/latest) 下载：

- **Windows**：`juyou-switcher-Windows.msi` 或 `-Portable.zip`
- **macOS**：`juyou-switcher-macOS.tar.gz` 或 `.zip`
- **Linux**：`juyou-switcher-Linux.AppImage` 或 `.deb`
...
- [@yangp0419](https://github.com/yangp0419) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "juyou-switcher" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=juyou-switcher)
...
- **问题反馈**：[GitHub Issues](https://github.com/yangp0419/juyou-switcher/issues)
- **讨论**：[GitHub Discussions](https://github.com/yangp0419/juyou-switcher/discussions)
