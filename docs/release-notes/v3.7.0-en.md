...
聚游助手 v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Windows**: `juyou-switcher-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `juyou-switcher-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `juyou-switcher-v3.7.0-Linux.AppImage` or `.deb`
