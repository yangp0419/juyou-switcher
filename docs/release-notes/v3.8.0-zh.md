...
聚游助手 v3.8.0 是一次重大的架构升级版本，重构了数据持久化层和用户界面，为未来的云同步和本地代理功能奠定基础。
...
- **Windows**：`juyou-switcher-v3.8.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`juyou-switcher-v3.8.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`juyou-switcher-v3.8.0-Linux.AppImage` 或 `.deb`
...
- [@yangp0419](https://github.com/yangp0419) - BUG 修复和功能增强
- 社区成员的测试和反馈
