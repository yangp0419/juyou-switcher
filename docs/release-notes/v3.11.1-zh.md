...
聚游助手 v3.11.1 是一个修复版本，回退了 v3.11.0 中引入的**部分键值合并**架构，恢复经过验证的「**全量配置覆写 + 通用配置片段**」机制，同时修复了多个 UI 和平台兼容性问题。
...
| 文件                                     | 说明                                |
| ---------------------------------------- | ----------------------------------- |
| `juyou-switcher-v3.11.1-Windows.msi`          | **推荐** - MSI 安装包，支持自动更新 |
| `juyou-switcher-v3.11.1-Windows-Portable.zip` | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                             | 说明                                                      |
| -------------------------------- | --------------------------------------------------------- |
| `juyou-switcher-v3.11.1-macOS.zip`    | **推荐** - 解压后拖入 Applications 即可，Universal Binary |
| `juyou-switcher-v3.11.1-macOS.tar.gz` | 用于 Homebrew 安装和自动更新                              |
