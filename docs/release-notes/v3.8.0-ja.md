...
聚游助手 v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/yangp0419/juyou-switcher/releases/latest) から入手:

- **Windows**: `juyou-switcher-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `juyou-switcher-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `juyou-switcher-v3.8.0-Linux.AppImage` または `.deb`
...
- [@yangp0419](https://github.com/yangp0419) - バグ修正と機能拡張
...
[登録時に「juyou-switcher」で 10% オフ](https://www.packyapi.com/register?aff=juyou-switcher)
...
- **Issue**: [GitHub Issues](https://github.com/yangp0419/juyou-switcher/issues)
