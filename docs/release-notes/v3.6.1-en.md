...
**[中文更新说明 Chinese Documentation →](https://github.com/yangp0419/juyou-switcher/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `juyou-switcher-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `juyou-switcher-v3.6.1-Windows.msi`
- **Portable**: `juyou-switcher-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `juyou-switcher-v3.6.1-Linux.AppImage`
- **Debian**: `juyou-switcher-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/yangp0419/juyou-switcher/blob/main/README_ZH.md)
- [English Documentation](https://github.com/yangp0419/juyou-switcher/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/yangp0419/juyou-switcher/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/yangp0419/juyou-switcher/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize 聚游助手's configuration storage directory
...
聚游助手 is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/yangp0419/juyou-switcher
