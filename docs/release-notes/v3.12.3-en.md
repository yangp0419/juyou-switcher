...
Added full reverse proxy support for GitHub Copilot, enabling Copilot-authenticated requests to be forwarded through 聚游助手.
...
- Backups stored in `~/.juyou-switcher/skill-backups/` with all skill files and a `meta.json` containing original metadata
...
Users enable this feature **at their own risk**. 聚游助手 is not responsible for any account restrictions, warnings, or service suspensions resulting from the use of this feature.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `juyou-switcher-v3.12.3-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `juyou-switcher-v3.12.3-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `juyou-switcher-v3.12.3-macOS.dmg`     | **Recommended** - DMG installer, drag to Applications, Universal Binary |
| `juyou-switcher-v3.12.3-macOS.zip`     | ZIP archive, extract and drag to Applications, Universal Binary      |
| `juyou-switcher-v3.12.3-macOS.tar.gz`  | For Homebrew installation and auto-update                            |
