...
聚游助手 v3.10.0 introduces OpenCode support, becoming the fourth managed CLI application.
...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `juyou-switcher-v3.10.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `juyou-switcher-v3.10.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                        |
| -------------------------------- | ------------------------------------------------------------------ |
| `juyou-switcher-v3.10.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `juyou-switcher-v3.10.0-macOS.tar.gz` | For Homebrew installation and auto-update                          |
