...
**[Use 聚游助手 to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
聚游助手 now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through 聚游助手's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — 聚游助手 fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes 聚游助手's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require 聚游助手's Local Routing to stay running while in use.
...
### 聚游助手 Brand Surface Unified to github.com/yangp0419/juyou-switcher

All in-app and README "official website" references now point at github.com/yangp0419/juyou-switcher as the sole official site; the release notes template also surfaces github.com/yangp0419/juyou-switcher.
...
The release notes template now surfaces `github.com/yangp0419/juyou-switcher`.

### Brand Surface

Documented `github.com/yangp0419/juyou-switcher` as the sole official website across READMEs and in-app references.
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `juyou-switcher-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `juyou-switcher-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `juyou-switcher-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `juyou-switcher-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `juyou-switcher-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `juyou-switcher-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `juyou-switcher-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
