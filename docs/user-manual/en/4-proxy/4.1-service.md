...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (聚游助手)
...
After starting the proxy and enabling app takeover, 聚游助手 modifies app configurations:
...
When stopping the proxy, 聚游助手 will:
