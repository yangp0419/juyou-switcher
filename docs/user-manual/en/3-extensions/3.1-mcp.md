...
> **Note**: OpenClaw and Claude Desktop do not currently support 聚游助手 MCP sync. MCP functionality is supported for Claude, Codex, Gemini, OpenCode, and Hermes.

### Toggle Implementation

When enabling an app's toggle, 聚游助手 will:
...
When disabling an app's toggle, 聚游助手 will:
...
If you have already configured MCP servers in CLI tools, you can import them into 聚游助手:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode/Hermes)
3. 聚游助手 reads the existing configuration and imports it
