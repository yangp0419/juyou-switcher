...
聚游助手 provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
juyouswitcher://import/prompt?data=<base64-encoded preset>
```
