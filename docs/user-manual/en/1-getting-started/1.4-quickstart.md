...
- Right-click the 聚游助手 icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in 聚游助手:

1. Open 聚游助手 "Settings > General"
