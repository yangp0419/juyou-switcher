...
聚游助手 is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
聚游助手 solves these problems through a unified interface.
...
聚游助手 is built with a modern technology stack:
