...
/**
 * Hermes Agent configuration API (app side).
 *
 * 聚游助手 intentionally keeps its Hermes surface minimal — deep configuration
 * (model, agent behavior, env vars, skills, cron, logs, analytics) lives in
 * the Hermes Web UI at http://127.0.0.1:9119. 聚游助手 only reads the `model`
