...
//!
//! 本模块处理 聚游助手 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | 聚游助手 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: 聚游助手 → OpenCode
// ============================================================================

/// Convert 聚游助手 unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → 聚游助手
// ============================================================================

/// Convert OpenCode format to 聚游助手 unified format
///
/// Conversion rules:
