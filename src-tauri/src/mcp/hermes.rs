...
//!
//! Handles conversion between 聚游助手 unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | 聚游助手 unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// 聚游助手 has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: 聚游助手 -> Hermes
// ============================================================================

/// Convert 聚游助手 unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> 聚游助手
// ============================================================================

/// Convert Hermes format to 聚游助手 unified format
///
/// Conversion rules:
...
/// `existing` — this prevents 聚游助手 from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive 聚游助手 round-trip"
        );
    }
