...
//!
//! This module is used when the Codex client talks to 聚游助手 through the
...
pub(crate) fn response_id_from_chat_id(id: Option<&str>) -> String {
    let id = id.unwrap_or("juyouswitcher");
...
mod tests {
    ...
    // https://github.com/yangp0419/juyou-switcher/issues/3557
