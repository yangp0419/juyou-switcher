//! Deep link import functionality for 聚游助手
//!
//! This module implements the juyouswitcher:// protocol for importing configurations
...
///
/// Represents a parsed juyouswitcher:// URL ready for processing.
