...
//!
//! Parses juyouswitcher:// URLs into DeepLinkImportRequest structures.
...
/// Parse a juyouswitcher:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// juyouswitcher://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "juyouswitcher" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'juyouswitcher', got '{scheme}'"
        )));
    }
